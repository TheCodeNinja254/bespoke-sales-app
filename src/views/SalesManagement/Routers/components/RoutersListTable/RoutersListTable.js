                ...
                <TableBody>
                  {sales.map((sale) => (
                    <TableRow
                      ...
                      selected={
                        selectedUsers.indexOf(sale.registrationId) !== -1
                      }>
                      <TableCell>
                      ...
                      {/* <TableCell> */}
                      {/*  <StatusBadge */}
                      {/*    bgColor={sale.routerDeliveryStatus === 1 ? theme.palette.success.main : theme.palette.warning.main} */}
                      {/*  > */}
                      {/*    {sale.routerDeliveryStatus === 0 ? 'Pending Delivery' : 'Router Delivered'} */}
                      {/*  </StatusBadge> */}
                      {/* </TableCell> */}
                      <TableCell>
