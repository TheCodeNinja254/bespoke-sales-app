...
const EditUserForm = () => {
  ...
  const lastName = 'Fredrick';
  const docNumber = 3456789;
  const msisdn = '7845162315';
  const createdBy = 'fmmmmmm';
  const agencyId = 1;
  const role = 'Admin';
  const userName = 'fmmmmmm';
          ...
          <Grid container spacing={3}>
            ...
            <Grid item lg={6} xs={12}>
              <TextField
                ...
                variant="outlined">
                {configs.shopAdminManageableUserRoles.map((roleItem) => (
